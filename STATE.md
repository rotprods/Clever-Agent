...
- Active subcheckpoint: `I02.2`
- Next executable wave: `CP02-W02 — Cross-runtime bindings and compatibility`
- Capability denominator: `7565`
- Clever VERIFIED parity: `0 / 7565`

## Canonical frontier

Execute `/empezarproyecto`, claim `CP02-W02`, and follow `iterations/02/METAPROMPT.md`. Contracts remain authoritative over kernel implementation.
