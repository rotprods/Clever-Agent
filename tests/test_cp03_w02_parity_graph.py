...
class W02ParityGraphTests(unittest.TestCase):
    ...
    def test_current_matrix_has_twenty_two_candidates_and_no_parity_promotion(self) -> None:
        ...
        self.assertEqual(sum(row["w02_evidence_state"] == "EVIDENCE_BACKED_CANDIDATE" for row in rows), 22)
        self.assertEqual(sum(row["w02_evidence_state"] == "UNBOUND" for row in rows), 25)
