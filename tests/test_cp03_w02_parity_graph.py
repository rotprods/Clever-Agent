...
INFERENCE_START_EVENT_PROTOCOL_TEST_ID = (
    "tests.test_cp03_w02_parity_graph.W02ParityGraphTests."
...
class W02ParityGraphTests(unittest.TestCase):
    ...
    def test_current_matrix_has_eighteen_candidates_and_no_parity_promotion(self) -> None:
        ...
        self.assertEqual(sum(row["w02_evidence_state"] == "EVIDENCE_BACKED_CANDIDATE" for row in rows), 18)
        self.assertEqual(sum(row["w02_evidence_state"] == "UNBOUND" for row in rows), 29)
        ...
        inference_start_event_protocol = candidates[INFERENCE_START_EVENT_PROTOCOL_CAPABILITY_ID]
    ...
    def test_inference_start_event_protocol_binding_is_capability_specific_and_source_backed(self) -> None:
