...
class W02ParityGraphTests(unittest.TestCase):
    ...
    def test_cli_ask_command_binding_is_capability_specific_and_source_backed(self) -> None:
    ...
    def test_learned_router_binding_is_capability_specific_and_source_backed(self) -> None:
    ...
    def test_server_chat_completions_binding_is_capability_specific_and_source_backed(self) -> None:
    ...
    def test_vllm_pearl_mining_binding_is_capability_specific_and_source_backed(self) -> None:
    ...
    def test_heuristic_router_binding_is_capability_specific_and_source_backed(self) -> None:
    ...
    def test_nexa_chat_completions_binding_is_capability_specific_and_source_backed(self) -> None:
