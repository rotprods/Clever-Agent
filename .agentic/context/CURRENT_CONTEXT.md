...
- `CLAIM-CP03-W02-PERFORMANCE-20260922` → `CP03-W02-PERFORMANCE-BASELINE-20260922` · `chatgpt-gpt-5.6-sol`
...
- `RISK-W02-PERFORMANCE-BASELINE-PENDING-20260922` · `P2` · `OPEN` · detail in `ledgers/RISK_LEDGER.ndjson`
