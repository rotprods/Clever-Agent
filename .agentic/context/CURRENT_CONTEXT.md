...
- `CLAIM-CP03-W02-STRUCTURED-TRANSPORT-20260921` → `CP03-W02-STRUCTURED-TRANSPORT-20260921` · `chatgpt-gpt-5.6-sol`
...
- `RISK-0013` · `HIGH` · `OPEN` · detail in `ledgers/RISK_LEDGER.ndjson`
