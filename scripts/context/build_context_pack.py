...
AUTHORITY_READ_ORDER = [
    ...
    "iterations/01/STATE.json", "IMPLEMENTATION_PLAN.md", "TASKS.md",
    ".agentic/context/NEXT_ACTIONS.json", ".agentic/context/CURRENT_CONTEXT.json", "HANDOFF.md",
]
...
def build_context_pack(root: Path = ROOT) -> dict[str, Any]:
    ...
    plan = _load_json(root, str(NEXT_ACTIONS_JSON))
    ...
    pack = {
        ...
        "frontier":{
            "checkpoint":execution["current_checkpoint"],"iteration":execution["active_iteration"],
